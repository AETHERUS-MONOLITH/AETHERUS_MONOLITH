...
export function evaluatePolicyDecision(policy, input) {
  ...
  return {
    ...
    runtime_enforcement_status:
      input.claim_id === "operator_review_escalation"
        ? "not_applicable"
        : policy.runtime_enforcement?.current_status || "unavailable",
...
export { evaluatePolicyDecision as evaluatePalisadeDecision };
